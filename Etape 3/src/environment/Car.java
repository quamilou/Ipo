...
public class Car {
	...
	public Car(Car car, int ord){
		this.game = car.game;
		this.leftToRight = car.leftToRight;
		this.length = car.game.randomGen.nextInt(3);
		if (leftToRight){
			leftPosition = new Case(car.leftPosition.absc, ord);
		} else {
			leftPosition = new Case(car.leftPosition.absc + length, ord);
		}
	}
